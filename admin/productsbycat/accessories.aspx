...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <asp:ListView ID="Products" runat="server" DataKeyNames="id" 
         DataSourceID="SqlDataSource1" OnSelectedIndexChanged="selected_product_delete">
                ...
                <div class="order-item">
                    ...
                    <div class="order-item-details">
                        ...
                        <p><strong>Price:</strong> 
                           ...
                           <asp:Button ID="Button1" runat="server" Text="Delete" CssClass ="ToTheBasket" CommandName="select"/>
                  <br/>
                    </div>
                </div>
            </ItemTemplate>
...
<asp:DataPager ID="DataPager1" runat="server" PageSize="6">
    <Fields>
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
      ...
      SelectCommand="SELECT [id],[name], [description], [image_url],[price]  FROM [Product] WHERE [category] = 'accessories'">
     </asp:SqlDataSource>
