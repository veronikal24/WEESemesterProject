...
<asp:ListView ID="BasketProducts" runat="server" DataKeyNames="product_name,order_id" 
        ...
        <div class="order-item">
            ...
            <div class="order-item-details">
                <p><strong>Order ID:</strong> 
                    <asp:Label ID="orderIdLabel" runat="server" Text='<%# Eval("order_id") %>' /></p>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT 
        ...
        customer_id
        FROM [ORDER] 
        WHERE customer_id = @customer_id ORDER BY timestamp DESC"
